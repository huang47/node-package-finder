...
var Package = Class.extend({
    ...
    init: function (meta) {
        ...
        this.readmes.subscribe(function (r) { self.readme = r.body; });
    },
    ...
    get readmes() {
        return Rx.Observable.create(function (o) {
            ...
            var url = util.sub(GITHUB_API, { author: this.author, packageName: this.name });

            request(url, function (e, response) {
                if (e) {
                    o.onNext({ body: '' })
                    return;
                }
